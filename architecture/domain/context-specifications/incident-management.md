# Context Specification — Incident Management

This document defines the canonical specification for the Incident Management Bounded Context.

---

## 1. Business Capability

Solves: Incident Triage & Task Dispatching.

## 2. Ubiquitous Language Mappings

- Context Owner: Operations Group.
- Authoritative terms: Incident, Task, Observation.
...
- Incident, Task, Observation

## 5. Owned Events

- evt_incident_detected

## 6. Owned Policies

- `pol_incident_management_default_rules`

## 7. Public Commands

- `cmd_incident_management_action`

## 8. Public Queries

- `qry_incident_management_data`
