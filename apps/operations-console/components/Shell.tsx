    ...
    <div style={{ display: "flex", minHeight: "100vh", backgroundColor: "var(--bg-base)" }}>
      ...
      >
        ...
        <div style={{ padding: "0 0.5rem 2rem 0.5rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontFamily: "var(--font-display)", fontWeight: 700, letterSpacing: "-0.02em" }}>
            MEVIS <span style={{ color: "var(--color-primary)", fontSize: "0.75rem", verticalAlign: "super" }}>SRE CONSOLE</span>
          </h2>
        </div>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: "none",
                  backgroundColor: isActive ? "hsla(171, 100%, 41%, 0.15)" : "transparent",
