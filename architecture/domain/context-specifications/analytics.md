# Context Specification — Analytics

This document defines the canonical specification for the Analytics Bounded Context.

---

## 1. Business Capability

Solves: Long-term KPI reporting & outcome audit.

## 2. Ubiquitous Language Mappings

- Context Owner: Operations Group.
- Authoritative terms: AnalyticsReport.
...
- `pol_analytics_default_rules`

## 7. Public Commands

- `cmd_analytics_action`
